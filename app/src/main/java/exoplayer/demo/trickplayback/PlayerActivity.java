...
public class PlayerActivity extends AppCompatActivity
        implements View.OnClickListener, ExoPlayer.EventListener, PlaybackControlView.VisibilityListener,
        LoaderManager.LoaderCallbacks<Cursor>, PlayRequest {

    public static final String TAG = "DemoPlayerActivity";
    ...
    public static final String ACTION_VIEW = "exoplayer.demo.trickplayback.action.VIEW";
    public static final String ACTION_VIEW_LIST = "exoplayer.demo.trickplayback.action.VIEW_LIST";
...
//        debugRootView.setVisibility(visibility);
    ...
    private void initializePlayer(Intent selfIntent) {
        Intent intent;
        if (selfIntent == null)
            intent = getIntent();
        else
...
//                showToast(getString(R.string.unexpected_intent_action, action));
    ...
    /** for local media chooser */
    private LocalMediaCursorAdapter mAdapter = null;
    ...
    public Loader onCreateLoader(int id, Bundle args) {
        ...
        return new CursorLoader(this, videoUri, projection, null, null, order);
    }
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        try {
            ...
            mChooserDialog.setAdapter(mAdapter);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
